...
public:
    ...
    static User generateUser() {
        std::vector<QString> names = {"Николай", "Яков", "Герман",
                                      "Василий", "Виктория", "Андрей",
                                      "София", "Кирилл", "Всеволод",
                                      "Максим", "Елена", "Кристина",
                                      "Варвара", "Дмитрий", "Полина",
                                      "Елизавета", "Тимофей", "Вероника",
                                      "Святослав", "Тимур"};
